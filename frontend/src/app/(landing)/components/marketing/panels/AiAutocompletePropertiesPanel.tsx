		...
		<div className="relative" ref={ref}>
			...
			>
				<CardContent className="mb-2 p-2">
					<h1 className="mb-2 text-lg">Lors de la création d&apos;une tâche</h1>
					<Textarea
						placeholder=""
						className="pointer-events-none h-[80px] resize-none border-none !bg-transparent p-0"
						readOnly
						value={
							"Décrivez-le et utilisez des propriétés intelligentes pour sélectionner automatiquement les propriétés des tâches à l'aide de l'IA."
						}
					/>
